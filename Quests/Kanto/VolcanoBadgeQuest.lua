...
function VolcanoBadgeQuest:CinnabarGym()
	if hasItem("Rare Candy") and getPokemonLevel(1) == 95 then
		return useItemOnPokemon("Rare Candy", 1)
	elseif hasItem("Rare Candy") and getPokemonLevel(1) == 96 then
		return useItemOnPokemon("Rare Candy", 1)
	elseif hasItem("Rare Candy") and getPokemonLevel(1) == 97 then
		return useItemOnPokemon("Rare Candy", 1)
	end
